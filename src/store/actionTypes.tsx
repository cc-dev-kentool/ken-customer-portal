...
export const promptActionType = {
  GET_LIST_PROMPT: "GET_LIST_PROMPT",
  GET_LIST_PROMPT_SUCCESS: "GET_LIST_PROMPT_SUCCESS",
  CREATE_PROMPT_SUCCESS: "CREATE_PROMPT_SUCCESS",
  EDIT_PROMPT_SUCCESS: "EDIT_PROMPT_SUCCESS",
}
