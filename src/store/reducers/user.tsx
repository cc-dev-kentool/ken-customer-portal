...
const userSetting = (state = initialState, action) => {
  switch (action.type) {
    ...
    // Case for SUSPEND_ACCOUNT_SUCCESS action type.
    case userActionType.SUSPEND_ACCOUNT_SUCCESS:
      return {
        ...state,
        suspendAccountSuccess: action.payload,
      }
